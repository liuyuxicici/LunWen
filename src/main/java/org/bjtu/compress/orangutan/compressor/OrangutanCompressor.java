...
import org.bjtu.compress.orangutan.xorcompressor.OrangutanXORCompressor;
import org.urbcomp.startdb.compress.elf.compressor.ICompressor;

public class OrangutanCompressor implements ICompressor {
    private final OrangutanXORCompressor xorCompressor;

    private final int reservedDpNumber;

    public OrangutanCompressor(int dp) {
        xorCompressor = new OrangutanXORCompressor();
