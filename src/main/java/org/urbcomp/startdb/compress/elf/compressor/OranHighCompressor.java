...
import org.urbcomp.startdb.compress.elf.xorcompressor.OranMpHighXorComp;
import org.urbcomp.startdb.compress.elf.xorcompressor.OranMpLowXorComp;

public class OranHighCompressor extends AbstractElfCompressor {
    private final OranMpHighXorComp xorCompressor;

    public OranHighCompressor() {
        xorCompressor = new OranMpHighXorComp();
    }
